...
{ 
	...
	var rates = document.getElementsByName('cancer');
	var cancer;
	for(var i = 0; i < rates.length; i++){
	    if(rates[i].checked){
	    	cancer = rates[i].value;
	    }
	}
	var cancsite = document.getElementById("cancsite").value;
	var phonenumberPattern = new RegExp("^[0-9]{10,10}$");
	if(( cancer == 1 || cancer == 2) && !phonenumberPattern.exec(cancsite.toString()))
	{
	 window.alert( "Please enter a valid primary site." );
	 return false;
	}
}
</script>
...
for Initial Visit Packet , Form D2.</i></font>
<br><br>
<br>
...
<form:form action="initiald2.do" method="POST" commandName ="initiald2" onsubmit="return validate();" >
<p class="even">
