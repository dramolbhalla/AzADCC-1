...
<form:form action="initialb83.do" method="POST" commandName="initialb83">
<p class="odd">
...
<form:input type="radio" name="othneur" path="othneur" required ="required" value="1" style="margin-left:10px;"/>1 &nbsp;Yes (SPECIFY) : <form:input type="text" name="othneurx" path="othneurx" style="margin-left:20px; width:300px ;"/> <br />
</p>
