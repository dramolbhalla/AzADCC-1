...
<form:form action="test1.do" method="POST" commandName="test1">
...
hers are stealing from him or her, or <br> planning to harm him or
her in some way? 
<td>2a.<form:input type="radio" name="myvalue1"  path="myvalue1" required ="required" value="1" style="margin-left:10px;" />1</td>
<td ><form:input type="radio" name="myvalue1" path="myvalue1" required ="required" value="0" style="margin-left:10px;" />0</td>
<td ><form:input type="radio" name="myvalue1" path="myvalue1" required ="required" value="9" style="margin-left:10px;" />9</td>
</tr>
