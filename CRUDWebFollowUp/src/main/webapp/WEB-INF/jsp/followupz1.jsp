...
<form:form action="followupz1.do" method="POST" commandName="followupz1">
...
<tr>
<td>C1 or C2</td><td>Neuropsychological Battery Scores</td><td bgcolor=Silver></td><td bgcolor=Silver></td><td bgcolor=Silver></td>
</tr>
<tr>
