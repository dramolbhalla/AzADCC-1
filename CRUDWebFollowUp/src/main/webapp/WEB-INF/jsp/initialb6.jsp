...
<br><br>
<br>
<form:form action="initialb6.do" method="POST" commandName="initialb6" onsubmit="return validate();">
<p class="odd" >
<form:input type="checkbox" name="nogds" value="1" path="nogds" style="margin-left:0px; 	text-align: justify; text-justify: inter-word;"/>
&nbsp;&nbsp;Check this box and enter "88" below for the Total GDS Score <b>if and only if </b> the subject: 1) does not
...
<br>
 ...
 <tr >
  ...
  <tr>
   ...
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="satis" path="satis" value="0" />&nbsp;0</td>
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="satis" path="satis" value="1" />&nbsp;1</td>
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="satis" path="satis" value="9" />&nbsp;9</td>
  </tr>
  <tr bgcolor="Silver">
  <td height="40" style="width:70%;">&nbsp;&nbsp;&nbsp;2 .Have you dropped many of your activities and interests?</td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="dropact" path="dropact" value="0" />&nbsp;0</td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="dropact" path="dropact" value="1" />&nbsp;1</td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="dropact" path="dropact" value="9" />&nbsp;9</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="stayhome" path="stayhome" value="0" />&nbsp;0</td>
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="stayhome" path="stayhome" value="1" />&nbsp;1</td>
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="stayhome" path="stayhome" value="9" />&nbsp;9</td>
  </tr>
  <tr bgcolor="Silver">
  <td height="40" style="width:70%;">&nbsp;&nbsp;&nbsp;10 .Do you feel you have more problems with memory than most?</td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="memprob" path="memprob" value="0" />&nbsp;0</td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="memprob" path="memprob" value="1" />&nbsp;1</td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="memprob" path="memprob" value="9" />&nbsp;9</td>
  </tr>
  <tr>
   <td height="40" style="width:70%;">&nbsp;&nbsp;&nbsp;11 .Do you think it is wonderful to be alive now? </td>
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="wondrful" path="wondrful"  value="0" />&nbsp;0</td>
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="wondrful" path="wondrful"  value="1" />&nbsp;1</td>
   <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="wondrful" path="wondrful"  value="9" />&nbsp;9</td>
  </tr>
  <tr bgcolor="Silver">
  <td height="40" style="width:70%;">&nbsp;&nbsp;&nbsp;12 .Do you feel pretty worthless the way you are now? </td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="wrthless" path="wrthless" value="0" />&nbsp;0</td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="wrthless" path="wrthless" value="1" />&nbsp;1</td>
  <td style="width:10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form:input type="radio" name="wrthless" path="wrthless" value="9" />&nbsp;9</td>
  </tr>
  <tr>
