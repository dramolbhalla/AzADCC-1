...
<form:form action="followupc1.do" method="POST" commandName="followupc1">
<p class="even">
1.  Was any part of the MMSE completed?
<form:input type="radio" name="mmsecomp" path="mmsecomp" required ="required" value="0" style="margin-left:80px;"/>0 No <font size=2px> (Enter reason code,95-98 ,and <b> SKIP to QUESTION 2a</b>):</font> <form:input type="text" name="mmsereas" path="mmsereas" size ="2" maxlength="2" style="margin-left:0px; width:50px;"/><br />
<form:input type="radio" name="mmsecomp" path="mmsecomp" required ="required" value="1" style="margin-left:352px;"/>1 Yes <b> <font size=2px>(CONTINUE TO QUESTION 1a) </font></b><br />
</p>
<p class="even">
1a.  Administration of the MMSE was?
<form:input type="radio" name="mmseloc" path="mmseloc" required ="required" value="1" style="margin-left:100px;"/>1 In ADC/clinic <br />
<form:input type="radio" name="mmseloc" path="mmseloc" required ="required" value="2" style="margin-left:352px;"/>2 In home <br />
<form:input type="radio" name="mmseloc" path="mmseloc" required ="required" value="3" style="margin-left:352px;"/>3 In person -other <br />
</p>
<p class="even">
1a1.  Language of MMSE administration?
<form:input type="radio" name="mmselan" path="mmselan" required ="required" value="1" style="margin-left:90px;"/>1 English <br />
<form:input type="radio" name="mmselan" path="mmselan" required ="required" value="2" style="margin-left:352px;"/>2 Spanish <br />
<form:input type="radio" name="mmselan" path="mmselan" required ="required" value="3" style="margin-left:352px;"/>3 Other (SPECIFY) : <form:input type="text" name="mmselanx" path="mmselanx" size ="20" maxlength="20" required ="required" style="margin-left:0px; width:50px;"/><br />
</p>
<p class="even">
1b. Subject was unable to complete one or more<br> sections due to visual impairment
<form:input type="radio" name="mmsevis" path="mmsevis" required ="required" value="0" style="margin-left:135px;"/>0 No<br />
<form:input type="radio" name="mmsevis" path="mmsevis" required ="required" value="1" style="margin-left:352px;"/>1 Yes <br />
</p>
<p class="even">
1c. Subject was unable to complete one or more<br> sections due to hearing impairment
<form:input type="radio" name="mmsehear" path="mmsehear"  required ="required" value="0" style="margin-left:125px;"/>0 No<br />
<form:input type="radio" name="mmsehear" path="mmsehear" required ="required" value="1" style="margin-left:352px;"/>1 Yes <br />
</p>
