...
@Entity
public class InitialA3 implements Serializable{
	/**
	 * 
	 */
	...
	/*public InitialA3(int a3, int nwinfmut, int fadmut, String fadmutx, int fadmuso,
	...
	/*public InitialA3(User user, Subject subject, Header header, int a3, int nwinfmut,
