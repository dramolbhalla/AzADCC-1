...
@Entity
public class InitialA2 implements Serializable {
	/**
	 * 
	 */
...
//	Header header;
	...
	@Id
	@Column
	@GeneratedValue(strategy=GenerationType.AUTO) //for autonumber@Column 
	 int a2;
		@Column 
	 int inbirmo;
		@Column 
...
String inraterx;
	...
	public InitialA2(int a2, int inbirmo, int inbiryr, int insex, int inhisp,
...
//	public InitialA2(User user, Subject subject, Header header, int a2, int inbirmo,
