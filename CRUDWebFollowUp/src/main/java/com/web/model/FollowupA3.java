...
public class FollowupA3 implements Serializable{
	...
	/**
	 * Since Hibernate can't instantiate it we have to go directly in the DB...
	 * @param session
	 * @param detailsid
	 * @throws an excecption if impossible to create
	 */
	public FollowupA3(SessionFactory session, int detailsid) throws Exception
	{
		super();
		...
		{
			/**
			 * !!!May crash if the data are incorrect TODO override the parse method and control the null value...
			 */			
			
			qr.append("SELECT a3, nwinfmut, fadmut, fadmutx, fadmuso, fadmusox, fftdmut, fftdmutx, fftdmuso, fftdmusx, fothmut, fothmutx, fothmuso, fothmusx, nwinfpar, mommob, momyob, momdage, momneur, momprdx, mommoe, momageo, dadmob, dadyob, daddage, dadneur, dadprdx, dadmoe, dadageo, sibs, nwinfsib, sib1mob, sib1yob, sib1agd, sib1neu, sib1pdx, sib1moe, sib1ago, sib2mob, sib2yob, sib2agd, sib2neu, sib2pdx, sib2moe, sib2ago, sib3mob, sib3yob, sib3agd, sib3neu, sib3pdx, sib3moe, sib3ago, sib4mob, sib4yob, sib4agd, sib4neu, sib4pdx, sib4moe, sib4ago, sib5mob, sib5yob, sib5agd, sib5neu, sib5pdx, sib5moe, sib5ago, sib6mob, sib6yob, sib6agd, sib6neu, sib6pdx, sib6moe, sib6ago, sib7mob, sib7yob, sib7agd, sib7neu, sib7pdx, sib7moe, sib7ago, sib8mob, sib8yob, sib8agd, sib8neu, sib8pdx, sib8moe, sib8ago, sib9mob, sib9yob, sib9agd, sib9neu, sib9pdx, sib9moe, sib9ago, sib10mob, sib10yob, sib10agd, sib10neu, sib10pdx, sib10moe, sib10ago, sib11mob, sib11yob, sib11agd, sib11neu, sib11pdx, sib11moe, sib11ago, sib12mob, sib12yob, sib12agd, sib12neu, sib12pdx, sib12moe, sib12ago, sib13mob, sib13yob, sib13agd, sib13neu, sib13pdx, sib13moe, sib13ago, sib14mob, sib14yob, sib14agd, sib14neu, sib14pdx, sib14moe, sib14ago, sib15mob, sib15yob, sib15agd, sib15neu, sib15pdx, sib15moe, sib15ago, sib16mob, sib16yob, sib16agd, sib16neu, sib16pdx, sib16moe, sib16ago, sib17mob, sib17yob, sib17agd, sib17neu, sib17pdx, sib17moe, sib17ago, sib18mob, sib18yob, sib18agd, sib18neu, sib18pdx, sib18moe, sib18ago, sib19mob, sib19yob, sib19agd, sib19neu, sib19pdx, sib19moe, sib19ago, sib20mob, sib20yob, sib20agd, sib20neu, sib20pdx, sib20moe, sib20ago, kids, nwinfkid, kid1mob, kid1yob, kid1agd, kid1neu, kid1pdx, kid1moe, kid1ago, kid2mob, kid2yob, kid2agd, kid2neu, kid2pdx, kid2moe, kid2ago, kid3mob, kid3yob, kid3agd, kid3neu, kid3pdx, kid3moe, kid3ago, kid4mob, kid4yob, kid4agd, kid4neu, kid4pdx, kid4moe, kid4ago, kid5mob, kid5yob, kid5agd, kid5neu, kid5pdx, kid5moe, kid5ago, kid6mob, kid6yob, kid6agd, kid6neu, kid6pdx, kid6moe, kid6ago, kid7mob, kid7yob, kid7agd, kid7neu, kid7pdx, kid7moe, kid7ago, kid8mob, kid8yob, kid8agd, kid8neu, kid8pdx, kid8moe, kid8ago, kid9mob, kid9yob, kid9agd, kid9neu, kid9pdx, kid9moe, kid9ago, kid10mob, kid10yob, kid10agd, kid10neu, kid10pdx, kid10moe, kid10ago, kid11mob, kid11yob, kid11agd, kid11neu, kid11pdx, kid11moe, kid11ago, kid12mob, kid12yob, kid12agd, kid12neu, kid12pdx, kid12moe, kid12ago, kid13mob, kid13yob, kid13agd, kid13neu, kid13pdx, kid13moe, kid13ago, kid14mob, kid14yob, kid14agd, kid14neu, kid14pdx, kid14moe, kid14ago, kid15mob, kid15yob, kid15agd, kid15neu, kid15pdx, kid15moe, kid15ago, header_fk_followupa3 FROM FollowupA3 WHERE a3= :detailsid");
			Query q = session.getCurrentSession().createSQLQuery(qr.toString())
					.addScalar("a3", new IntegerType())
					.addScalar("nwinfmut", new IntegerType())
					.addScalar("fadmut",  new IntegerType())
					.addScalar("fadmutx", new StringType())
					.addScalar("fadmuso", new IntegerType())
					.addScalar("fadmusox", new StringType())
					.addScalar("fftdmut", new IntegerType())
					.addScalar("fftdmutx", new StringType())
					.addScalar("fftdmuso", new IntegerType())
					.addScalar("fftdmusx", new StringType())
					.addScalar("fothmut", new IntegerType())
					.addScalar("fothmutx", new StringType())
					.addScalar("fothmuso", new IntegerType())
					.addScalar("fothmusx", new StringType())
					.addScalar("nwinfpar", new IntegerType())
					.addScalar("mommob", new IntegerType())
					.addScalar("momyob", new IntegerType())
					.addScalar("momdage", new IntegerType())
					.addScalar("momneur", new IntegerType())
					.addScalar("momprdx", new IntegerType())
					.addScalar("mommoe", new IntegerType())
					.addScalar("momageo", new IntegerType())
					.addScalar("dadmob", new IntegerType())
					.addScalar("dadyob", new IntegerType())
					.addScalar("daddage", new IntegerType())
					.addScalar("dadneur", new IntegerType())
					.addScalar("dadprdx", new IntegerType())
					.addScalar("dadmoe", new IntegerType())
					.addScalar("dadageo", new IntegerType())
					.addScalar("sibs", new IntegerType())
					.addScalar("nwinfsib", new IntegerType())
					.addScalar("sib1mob", new IntegerType())
					.addScalar("sib1yob", new IntegerType())
					.addScalar("sib1agd", new IntegerType())
					.addScalar("sib1neu", new IntegerType())
					.addScalar("sib1pdx", new IntegerType())
					.addScalar("sib1moe", new IntegerType())
					.addScalar("sib1ago", new IntegerType())
					.addScalar("sib2mob", new IntegerType())
					.addScalar("sib2yob", new IntegerType())
					.addScalar("sib2agd", new IntegerType())
					.addScalar("sib2neu", new IntegerType())
					.addScalar("sib2pdx", new IntegerType())
					.addScalar("sib2moe", new IntegerType())
					.addScalar("sib2ago", new IntegerType())
					.addScalar("sib3mob", new IntegerType())
					.addScalar("sib3yob", new IntegerType())
					.addScalar("sib3agd", new IntegerType())
					.addScalar("sib3neu", new IntegerType())
					.addScalar("sib3pdx", new IntegerType())
					.addScalar("sib3moe", new IntegerType())
					.addScalar("sib3ago", new IntegerType())
					.addScalar("sib4mob", new IntegerType())
					.addScalar("sib4yob", new IntegerType())
					.addScalar("sib4agd", new IntegerType())
					.addScalar("sib4neu", new IntegerType())
					.addScalar("sib4pdx", new IntegerType())
					.addScalar("sib4moe", new IntegerType())
					.addScalar("sib4ago", new IntegerType())
					.addScalar("sib5mob", new IntegerType())
					.addScalar("sib5yob", new IntegerType())
					.addScalar("sib5agd", new IntegerType())
					.addScalar("sib5neu", new IntegerType())
					.addScalar("sib5pdx", new IntegerType())
					.addScalar("sib5moe", new IntegerType())
					.addScalar("sib5ago", new IntegerType())
					.addScalar("sib6mob", new IntegerType())
					.addScalar("sib6yob", new IntegerType())
					.addScalar("sib6agd", new IntegerType())
					.addScalar("sib6neu", new IntegerType())
					.addScalar("sib6pdx", new IntegerType())
					.addScalar("sib6moe", new IntegerType())
					.addScalar("sib6ago", new IntegerType())
					.addScalar("sib7mob", new IntegerType())
					.addScalar("sib7yob", new IntegerType())
					.addScalar("sib7agd", new IntegerType())
					.addScalar("sib7neu", new IntegerType())
					.addScalar("sib7pdx", new IntegerType())
					.addScalar("sib7moe", new IntegerType())
					.addScalar("sib7ago", new IntegerType())
					.addScalar("sib8mob", new IntegerType())
					.addScalar("sib8yob", new IntegerType())
					.addScalar("sib8agd", new IntegerType())
					.addScalar("sib8neu", new IntegerType())
					.addScalar("sib8pdx", new IntegerType())
					.addScalar("sib8moe", new IntegerType())
					.addScalar("sib8ago", new IntegerType())
					.addScalar("sib9mob", new IntegerType())
					.addScalar("sib9yob", new IntegerType())
					.addScalar("sib9agd", new IntegerType())
					.addScalar("sib9neu", new IntegerType())
					.addScalar("sib9pdx", new IntegerType())
					.addScalar("sib9moe", new IntegerType())
					.addScalar("sib9ago", new IntegerType())
					.addScalar("sib10mob", new IntegerType())
					.addScalar("sib10yob", new IntegerType())
					.addScalar("sib10agd", new IntegerType())
					.addScalar("sib10neu", new IntegerType())
					.addScalar("sib10pdx", new IntegerType())
					.addScalar("sib10moe", new IntegerType())
					.addScalar("sib10ago", new IntegerType())
					.addScalar("sib11mob", new IntegerType())
					.addScalar("sib11yob", new IntegerType())
					.addScalar("sib11agd", new IntegerType())
					.addScalar("sib11neu", new IntegerType())
					.addScalar("sib11pdx", new IntegerType())
					.addScalar("sib11moe", new IntegerType())
					.addScalar("sib11ago", new IntegerType())
					.addScalar("sib12mob", new IntegerType())
					.addScalar("sib12yob", new IntegerType())
					.addScalar("sib12agd", new IntegerType())
					.addScalar("sib12neu", new IntegerType())
					.addScalar("sib12pdx", new IntegerType())
					.addScalar("sib12moe", new IntegerType())
					.addScalar("sib12ago", new IntegerType())
					.addScalar("sib13mob", new IntegerType())
					.addScalar("sib13yob", new IntegerType())
					.addScalar("sib13agd", new IntegerType())
					.addScalar("sib13neu", new IntegerType())
					.addScalar("sib13pdx", new IntegerType())
					.addScalar("sib13moe", new IntegerType())
					.addScalar("sib13ago", new IntegerType())
					.addScalar("sib14mob", new IntegerType())
					.addScalar("sib14yob", new IntegerType())
					.addScalar("sib14agd", new IntegerType())
					.addScalar("sib14neu", new IntegerType())
					.addScalar("sib14pdx", new IntegerType())
					.addScalar("sib14moe", new IntegerType())
					.addScalar("sib14ago", new IntegerType())
					.addScalar("sib15mob", new IntegerType())
					.addScalar("sib15yob", new IntegerType())
					.addScalar("sib15agd", new IntegerType())
					.addScalar("sib15neu", new IntegerType())
					.addScalar("sib15pdx", new IntegerType())
					.addScalar("sib15moe", new IntegerType())
					.addScalar("sib15ago", new IntegerType())
					.addScalar("sib16mob", new IntegerType())
					.addScalar("sib16yob", new IntegerType())
					.addScalar("sib16agd", new IntegerType())
					.addScalar("sib16neu", new IntegerType())
					.addScalar("sib16pdx", new IntegerType())
					.addScalar("sib16moe", new IntegerType())
					.addScalar("sib16ago", new IntegerType())
					.addScalar("sib17mob", new IntegerType())
					.addScalar("sib17yob", new IntegerType())
					.addScalar("sib17agd", new IntegerType())
					.addScalar("sib17neu", new IntegerType())
					.addScalar("sib17pdx", new IntegerType())
					.addScalar("sib17moe", new IntegerType())
					.addScalar("sib17ago", new IntegerType())
					.addScalar("sib18mob", new IntegerType())
					.addScalar("sib18yob", new IntegerType())
					.addScalar("sib18agd", new IntegerType())
					.addScalar("sib18neu", new IntegerType())
					.addScalar("sib18pdx", new IntegerType())
					.addScalar("sib18moe", new IntegerType())
					.addScalar("sib18ago", new IntegerType())
					.addScalar("sib19mob", new IntegerType())
					.addScalar("sib19yob", new IntegerType())
					.addScalar("sib19agd", new IntegerType())
					.addScalar("sib19neu", new IntegerType())
					.addScalar("sib19pdx", new IntegerType())
					.addScalar("sib19moe", new IntegerType())
					.addScalar("sib19ago", new IntegerType())
					.addScalar("sib20mob", new IntegerType())
					.addScalar("sib20yob", new IntegerType())
					.addScalar("sib20agd", new IntegerType())
					.addScalar("sib20neu", new IntegerType())
					.addScalar("sib20pdx", new IntegerType())
					.addScalar("sib20moe", new IntegerType())
					.addScalar("sib20ago", new IntegerType())
					.addScalar("kids", new IntegerType())
					.addScalar("nwinfkid", new IntegerType())
					.addScalar("kid1mob", new IntegerType())
					.addScalar("kid1yob", new IntegerType())
					.addScalar("kid1agd", new IntegerType())
					.addScalar("kid1neu", new IntegerType())
					.addScalar("kid1pdx", new IntegerType())
					.addScalar("kid1moe", new IntegerType())
					.addScalar("kid1ago", new IntegerType())
					.addScalar("kid2mob", new IntegerType())
					.addScalar("kid2yob", new IntegerType())
					.addScalar("kid2agd", new IntegerType())
					.addScalar("kid2neu", new IntegerType())
					.addScalar("kid2pdx", new IntegerType())
					.addScalar("kid2moe", new IntegerType())
					.addScalar("kid2ago", new IntegerType())
					.addScalar("kid3mob", new IntegerType())
					.addScalar("kid3yob", new IntegerType())
					.addScalar("kid3agd", new IntegerType())
					.addScalar("kid3neu", new IntegerType())
					.addScalar("kid3pdx", new IntegerType())
					.addScalar("kid3moe", new IntegerType())
					.addScalar("kid3ago", new IntegerType())
					.addScalar("kid4mob", new IntegerType())
					.addScalar("kid4yob", new IntegerType())
					.addScalar("kid4agd", new IntegerType())
					.addScalar("kid4neu", new IntegerType())
					.addScalar("kid4pdx", new IntegerType())
					.addScalar("kid4moe", new IntegerType())
					.addScalar("kid4ago", new IntegerType())
					.addScalar("kid5mob", new IntegerType())
					.addScalar("kid5yob", new IntegerType())
					.addScalar("kid5agd", new IntegerType())
					.addScalar("kid5neu", new IntegerType())
					.addScalar("kid5pdx", new IntegerType())
					.addScalar("kid5moe", new IntegerType())
					.addScalar("kid5ago", new IntegerType())
					.addScalar("kid6mob", new IntegerType())
					.addScalar("kid6yob", new IntegerType())
					.addScalar("kid6agd", new IntegerType())
					.addScalar("kid6neu", new IntegerType())
					.addScalar("kid6pdx", new IntegerType())
					.addScalar("kid6moe", new IntegerType())
					.addScalar("kid6ago", new IntegerType())
					.addScalar("kid7mob", new IntegerType())
					.addScalar("kid7yob", new IntegerType())
					.addScalar("kid7agd", new IntegerType())
					.addScalar("kid7neu", new IntegerType())
					.addScalar("kid7pdx", new IntegerType())
					.addScalar("kid7moe", new IntegerType())
					.addScalar("kid7ago", new IntegerType())
					.addScalar("kid8mob", new IntegerType())
					.addScalar("kid8yob", new IntegerType())
					.addScalar("kid8agd", new IntegerType())
					.addScalar("kid8neu", new IntegerType())
					.addScalar("kid8pdx", new IntegerType())
					.addScalar("kid8moe", new IntegerType())
					.addScalar("kid8ago", new IntegerType())
					.addScalar("kid9mob", new IntegerType())
					.addScalar("kid9yob", new IntegerType())
					.addScalar("kid9agd", new IntegerType())
					.addScalar("kid9neu", new IntegerType())
					.addScalar("kid9pdx", new IntegerType())
					.addScalar("kid9moe", new IntegerType())
					.addScalar("kid9ago", new IntegerType())
					.addScalar("kid10mob", new IntegerType())
					.addScalar("kid10yob", new IntegerType())
					.addScalar("kid10agd", new IntegerType())
					.addScalar("kid10neu", new IntegerType())
					.addScalar("kid10pdx", new IntegerType())
					.addScalar("kid10moe", new IntegerType())
					.addScalar("kid10ago", new IntegerType())
					.addScalar("kid11mob", new IntegerType())
					.addScalar("kid11yob", new IntegerType())
					.addScalar("kid11agd", new IntegerType())
					.addScalar("kid11neu", new IntegerType())
					.addScalar("kid11pdx", new IntegerType())
					.addScalar("kid11moe", new IntegerType())
					.addScalar("kid11ago", new IntegerType())
					.addScalar("kid12mob", new IntegerType())
					.addScalar("kid12yob", new IntegerType())
					.addScalar("kid12agd", new IntegerType())
					.addScalar("kid12neu", new IntegerType())
					.addScalar("kid12pdx", new IntegerType())
					.addScalar("kid12moe", new IntegerType())
					.addScalar("kid12ago", new IntegerType())
					.addScalar("kid13mob", new IntegerType())
					.addScalar("kid13yob", new IntegerType())
					.addScalar("kid13agd", new IntegerType())
					.addScalar("kid13neu", new IntegerType())
					.addScalar("kid13pdx", new IntegerType())
					.addScalar("kid13moe", new IntegerType())
					.addScalar("kid13ago", new IntegerType())
					.addScalar("kid14mob", new IntegerType())
					.addScalar("kid14yob", new IntegerType())
					.addScalar("kid14agd", new IntegerType())
					.addScalar("kid14neu", new IntegerType())
					.addScalar("kid14pdx", new IntegerType())
					.addScalar("kid14moe", new IntegerType())
					.addScalar("kid14ago", new IntegerType())
					.addScalar("kid15mob", new IntegerType())
					.addScalar("kid15yob", new IntegerType())
					.addScalar("kid15agd", new IntegerType())
					.addScalar("kid15neu", new IntegerType())
					.addScalar("kid15pdx", new IntegerType())
					.addScalar("kid15moe", new IntegerType())
					.addScalar("kid15ago", new IntegerType())
					.setParameter("detailsid", detailsid);
			if(q.list().size()!=1){
				System.err.print("manage the error");
			}
			else
			{
				...
				for(Object[] row: rows){
					int cpt = 0;
					setA3(formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setNwinfmut(formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setFadmut  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setFadmutx  (formatDBStringInput(row[cpt]));
					cpt = cpt+1;
					setFadmuso  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setFadmusox  (formatDBStringInput(row[cpt]));
					cpt = cpt+1;
					setFftdmut  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setFftdmutx  (formatDBStringInput(row[cpt]));
					cpt = cpt+1;
					setFftdmuso  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setFftdmusx  (formatDBStringInput(row[cpt]));
					cpt = cpt+1;
					setFothmut  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setFothmutx  (formatDBStringInput(row[cpt]));
					cpt = cpt+1;
					setFothmuso  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setFothmusx  (formatDBStringInput(row[cpt]));
					cpt = cpt+1;
					setNwinfpar (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setMommob  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setMomyob  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setMomdage  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setMomneur  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setMomprdx  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setMommoe  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setMomageo  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setDadmob  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setDadyob  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setDaddage  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setDadneur  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setDadprdx  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setDadmoe  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setDadageo  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSibs  (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setNwinfsib (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib1mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib1yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib1agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib1neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib1pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib1moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib1ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib2mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib2yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib2agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib2neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib2pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib2moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib2ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib3mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib3yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib3agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib3neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib3pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib3moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib3ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib4mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib4yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib4agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib4neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib4pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib4moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib4ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib5mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib5yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib5agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib5neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib5pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib5moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib5ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib6mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib6yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib6agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib6neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib6pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib6moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib6ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib7mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib7yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib7agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib7neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib7pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib7moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib7ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib8mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib8yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib8agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib8neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib8pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib8moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib8ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib9mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib9yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib9agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib9neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib9pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib9moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib9ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib10mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib10yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib10agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib10neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib10pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib10moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib10ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib11mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib11yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib11agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib11neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib11pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib11moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib11ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib12mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib12yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib12agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib12neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib12pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib12moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib12ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib13mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib13yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib13agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib13neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib13pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib13moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib13ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib14mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib14yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib14agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib14neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib14pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib14moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib14ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib15mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib15yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib15agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib15neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib15pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib15moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib15ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib16mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib16yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib16agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib16neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib16pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib16moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib16ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib17mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib17yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib17agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib17neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib17pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib17moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib17ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib18mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib18yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib18agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib18neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib18pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib18moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib18ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib19mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib19yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib19agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib19neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib19pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib19moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib19ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setSib20mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib20yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib20agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib20neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib20pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib20moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setSib20ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKids (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setNwinfkid (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid1mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid1yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid1agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid1neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid1pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid1moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid1ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid2mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid2yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid2agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid2neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid2pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid2moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid2ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid3mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid3yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid3agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid3neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid3pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid3moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid3ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid4mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid4yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid4agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid4neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid4pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid4moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid4ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid5mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid5yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid5agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid5neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid5pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid5moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid5ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid6mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid6yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid6agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid6neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid6pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid6moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid6ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid7mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid7yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid7agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid7neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid7pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid7moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid7ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid8mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid8yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid8agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid8neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid8pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid8moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid8ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid9mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid9yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid9agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid9neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid9pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid9moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid9ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid10mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid10yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid10agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid10neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid10pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid10moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid10ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid11mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid11yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid11agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid11neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid11pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid11moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid11ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid12mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid12yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid12agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid12neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid12pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid12moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid12ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid13mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid13yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid13agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid13neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid13pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid13moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid13ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid14mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid14yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid14agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid14neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid14pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid14moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid14ago (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;

					setKid15mob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid15yob (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid15agd (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid15neu (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid15pdx (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid15moe (formatDBIntegerInput(row[cpt]));
					cpt = cpt+1;
					setKid15ago (formatDBIntegerInput(row[cpt]));
				}
			}

		}catch(Exception e){
			throw new Exception("An error occured when querying the DB with the request: ["+qr.toString()+"]: "+e.getMessage());
		}
	}
	
	protected String formatDBStringInput(Object input){
		if(input==null)
			return "";
		else return input.toString();
	}
	/**
	 * format the input comming from the DB
	 * @param input
	 */
	protected Integer formatDBIntegerInput(Object input)
	{
		if(input==null){
			System.err.print("I received null when I expected an integer, return 0");
			return 0;
		}
		try{
			return Integer.parseInt(input.toString());
		}catch (NumberFormatException e){
			System.err.print("Apparently I have a problem with an input from the data in FollowupA3 expected int get ["+input+"], return null but check the DB...");
			return null;
		}catch (Exception e) {
			System.err.print("Another error when parsing the data in FollowupA3 expected int get ["+input+"], return null but check the DB...");
			return null;
		}
	}
	
	//Impossible to have more than 255 parameters in Java, consequence hibernate don't call the default parameter
	//when reading the object from the DB (inserting is ok though since the object is already in memory but the key is not updated)
	//I didn't try vararg FollowupA3(Object... args) which can be a solution
/*	public FollowupA3(int a3, int nwinfmut, int fadmut, String fadmutx, int fadmuso,
	...
	public int getNwinfpar() {
		return nwinfpar;
	}

	public void setNwinfpar(int nwinfpar) {
