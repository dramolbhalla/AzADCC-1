...
@Entity
public class InitialD2 implements Serializable{
/**
	 * 
	 */
...
//	Header header;
 ...
 String othcondx;
	...
	public InitialD2(int d2, int cancer, int cancsite, int diabet, int myoinf,
...
//	public InitialD2(User user, Subject subject, Header header, int d2, int cancer,
