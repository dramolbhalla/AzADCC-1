...
@Entity
public class InitialD1 implements Serializable {
	/**
	 * 
	 */
...
//	Header header;
 ...
 String cogoth3x;
	...
	public InitialD1(int d1, int dxmethod, int normcog, int demented, int amndem,
...
//	public InitialD1(User user, Subject subject, Header header, int d1, int dxmethod,
