...
@Entity
public class InitialB5 implements Serializable{
//	User user;
//	Subject subject;
//	Header header;
 ...
 int appsev;
	...
	public InitialB5(int b5, int npiqinf, String npiqinfx, int del, int delsev,
...
//	public InitialB5(User user, Subject subject, Header header, int b5, int npiqinf,
