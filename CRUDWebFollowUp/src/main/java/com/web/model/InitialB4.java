...
@Entity
public class InitialB4 implements Serializable{
//	User user;
//	Subject subject;
//	Header header;
	...
	public InitialB4(int b4, float memory, float orient, float judgment, float commun,
...
//	public InitialB4(User user, Subject subject, Header header, int b4, int memory,
