...
@Entity
public class InitialB7 implements Serializable{
//	User user;
//	Subject subject;
//	Header header;
 ...
 int travel;
	...
	public InitialB7(int b7, int bills, int taxes, int shopping, int games, int stove,
...
//	public InitialB7(User user, Subject subject, Header header, int b7, int bills,
