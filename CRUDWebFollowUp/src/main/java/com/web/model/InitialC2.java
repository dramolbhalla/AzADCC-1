...
@Entity
public class InitialC2 implements Serializable{
	/**
	 * 
	 */
...
//	Header header;
 ...
 int  cogstat;
	...
	public InitialC2(int c2, int mocacomp, int mocareas, int mocaloc, int mocalan,
...
//	public InitialC2(User user, Subject subject, Header header, int c2, int mocacomp,
